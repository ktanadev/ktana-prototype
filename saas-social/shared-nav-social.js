...
(function() {
  ...
  const chatContexts = {
    ...
    'pipeline':    { avatar:'Sc', name:'Scout — Pipeline', sender:'Scout', greeting:'Pipeline em tempo real: 3 pesquisas, 4 pautas, 3 roteiros, 2 designs, 3 aprovacoes, 5 agendados. Carrossel do Joao atrasado.', chips:['Filtrar cliente','Ver atrasados','Mover cards'] },
