...
(function() {
  ...
  const systemNav = `
    <div class="ss-nav-section">
      ...
      <a class="${isActive('team')}" href="client-list.html">
        <svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
        Equipe
      </a>
      <a class="${isActive('config')}" href="connections.html">
        <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M12 1v6M12 17v6M4.22 4.22l4.24 4.24M15.54 15.54l4.24 4.24"/></svg>
        Config
      </a>
    </div>
  `;
