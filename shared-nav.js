...
(function() {
  ...
  const NAV_ITEMS = [
    {
      label: 'Painel',
      items: [
        { label: 'Dashboard', href: t('dashboard/home.html'), icon: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z' },
    ...
    },
    {
      label: 'Equipe',
      items: [
        { label: 'Samurais', href: t('team/list.html'), icon: 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2' },
        { label: 'Organograma', href: t('team/org.html'), icon: 'M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5' },
        { label: 'Contratar', href: t('team/hire-level.html'), icon: 'M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M19 8l3 3-3 3M15 11h7' },
    ...
    },
    {
      label: 'Solucoes',
      items: [
        { label: 'Marketplace', href: t('solutions/index.html'), icon: 'M20.59 13.41l-7.17 7.17a2 2 0 01-2.83 0L2 12V2h10l8.59 8.59a2 2 0 010 2.82z' },
        { label: 'Builder', href: t('solutions/builder.html'), icon: 'M12 5v14M5 12h14' },
        { label: 'Frameworks', href: t('frameworks/index.html'), icon: 'M4 4h16v16H4zM4 9h16M9 4v16' },
      ]
    },
    {
      label: 'Aprovacoes',
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Inteligencia', href: t('settings/models.html'), icon: 'M12 2a10 10 0 100 20 10 10 0 000-20zM2 12h20' },
        ...
        { label: 'Plano & Uso', href: t('settings/billing.html'), icon: 'M21 4H3a2 2 0 00-2 2v12a2 2 0 002 2h18a2 2 0 002-2V6a2 2 0 00-2-2zM1 10h22' },
      ]
    },
  ];
  ...
  style.textContent = `
    ...
    .kn-items { display: flex; align-items: center; gap: 4px; }
    .kn-cat { position: relative; }
    .kn-cat-label { font-family: 'Inter', -apple-system, sans-serif; font-size: 12px; color: #1D1D1F; opacity: 0.45; cursor: pointer; padding: 14px 14px; display: block; transition: opacity 0.15s; }
