...
(function() {
  ...
  const skipChat = path.includes('/builder') || (currentFile === 'home.html' && path.includes('/dashboard/')) || currentFile === 'chat.html' || currentFile === 'terminal.html' || currentFile === 'support.html' || currentFile === 'org.html' || (currentFile === 'list.html' && path.includes('/approvals/')) || currentFile === 'expert-chat.html';
  if (skipChat) {
